...
Le produit ne sera utilisé qu'une très courte partie de l'année
### b. Hypothèses que l’équipe fait sur le projet 
Si le personnes utilisant le produit est important il faudra surement régler des problèmes que nous ne voyons pas encore.
...
→ Renvoyer vers une annexe 2 (au format paysage) qui contient un extrait de la liste des exigences qualifiées limitées aux entrées de type « exigences fonctionnelles » (au sens de Wiegers).
